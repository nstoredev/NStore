...
namespace NStore.Sample.Tests
{
    public class DateRangeTests
    {
        ...
        [Fact]
        public void from_date_cannot_be_greater_than_to_date()
        {
            Assert.Throws<InvalidDateRangeException>(() => new DateRange(DateTime.Parse("2017-01-02"), DateTime.Parse("2017-01-01")));
        }
    }
}
