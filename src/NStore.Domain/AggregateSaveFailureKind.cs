...
{
    /// <summary>
    /// Represents the categorized outcome of an individual aggregate save operation.
    /// This can represent both successful operations (with special conditions) and failures.
    /// </summary>
    public enum AggregateSaveOutcome
    {
        /// <summary>
